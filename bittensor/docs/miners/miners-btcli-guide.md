...
- [Wallets, Coldkeys and Hotkeys in Bittensor](../keys/wallets) for an introduction to the authentication technology used in Bittensor.
- [Coldkey and Hotkey Workstation Security](../keys/coldkey-hotkey-security) for contrete security details about managing keys material.
